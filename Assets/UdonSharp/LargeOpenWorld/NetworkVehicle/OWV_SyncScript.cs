...
namespace LargeOpenWorld.Vehicle
{
    ...
    public class OWV_SyncScript : UdonSharpBehaviour
    {
        ...
        public OpenWorldVehicle OpenWorldVehicle;
        ...
        private Vector3 O_OffsetPosition;
        ...
        private void InitSyncValues()
        {
            ...
            nextUpdateTime = StartupServerTime + (double)(Time.time - StartupLocalTime + UnityEngine.Random.Range(0f, updateInterval));
        ...
        public void DeserializationStuff()
        {
            ...
            Vector2 tileOffset = (OpenWorldVehicle.VehicleTileLocation - OpenWorldVehicle.Island.TileLoader.GetLatestTile()) * OpenWorldVehicle.Island.TileLoader.TileSize;
            O_OffsetPosition = O_Position + new Vector3(tileOffset.x, 0, tileOffset.y);
            ...
            if (O_CurVel.sqrMagnitude == 0)
            {
                ...
                { L_CurVel = (O_OffsetPosition - O_LastPosition) * speednormalizer; }
            }
            else
            { L_CurVel = O_CurVel; }
            ...
            L_PingAdjustedPosition = O_OffsetPosition + (ExtrapolationDirection * Ping);
            ...
            if (Vector3.Angle(O_OffsetPosition - O_LastPosition, O_CurVel) > TeleportAngleDifference && L_CurVel.magnitude > 30f)
            {
                LastCurAngMom = CurAngMom;
            ...
            O_LastPosition = O_OffsetPosition;
